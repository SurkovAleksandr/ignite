...
Немного подебажил ⁣ ⁣- добавил параметр -DIGNITE_NO_SHUTDOWN_HOOK=true и еще теперь останавливаю ноду через Ignition.stop(ignite.name(), false), т.к. метод ignite.close() отменяет текущие таски.
